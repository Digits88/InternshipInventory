...
class SaveInternship {
    ...
    public function execute()
    {
        ...
        $i->setFirstNameMetaphone($i->first_name);
        $i->setMiddleNameMetaphone($i->middle_name);
        $i->setLastNameMetaphone($i->last_name);
        $i->setPreferredNameMetaphone($i->preferred_name);
